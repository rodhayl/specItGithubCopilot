...
describe('LLMService', () => {
    ...
    describe('initialize()', () => {
        it('should select gpt-5-mini family models first', async () => {
        ...
        it('should fall back to any Copilot model when no gpt-5-mini models are available', async () => {
            vscode.lm.selectChatModels
                .mockResolvedValueOnce([]) // no gpt-5-mini
