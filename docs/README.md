...
- **GitHub Repository**: [github.com/rodhayl/specItGithubCopilot](https://github.com/rodhayl/specItGithubCopilot)
- **VS Code Marketplace**: [marketplace.visualstudio.com](https://marketplace.visualstudio.com)
- **Issue Tracker**: [github.com/rodhayl/specItGithubCopilot/issues](https://github.com/rodhayl/specItGithubCopilot/issues)
