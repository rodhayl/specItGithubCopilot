...
4. **Report Issues**
   - [GitHub Issues](https://github.com/rodhayl/specItGithubCopilot/issues)
...
**Need help?** Check our [Troubleshooting Guide](troubleshooting.md) or [open an issue](https://github.com/rodhayl/specItGithubCopilot/issues).